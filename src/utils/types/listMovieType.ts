...
export const listNation: Record<string, ListType> = {
    "trung-quoc": {
        ...
        endpoint: "api/gauflix/nation/trung-quoc",
    },
    "han-quoc": {
        title: "Hàn Quốc",
        description: "Phim Hàn Quốc lãng mạn, đầy cảm xúc",
        breadcrumb: "Hàn Quốc",
        endpoint: "api/gauflix/nation/han-quoc",
    },
    "nhat-ban": {
        title: "Nhật Bản",
        description: "Phim Nhật Bản tinh tế và độc đáo",
        breadcrumb: "Nhật Bản",
        endpoint: "api/gauflix/nation/nhat-ban",
    },
    "thai-lan": {
        title: "Thái Lan",
        description: "Phim Thái Lan kịch tính và hấp dẫn",
        breadcrumb: "Thái Lan",
        endpoint: "api/gauflix/nation/thai-lan",
    },
    "au-my": {
        title: "Âu Mỹ",
