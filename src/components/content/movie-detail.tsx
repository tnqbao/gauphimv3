...
import {Calendar, Clock, Film, Heart, Play, Share2, User} from "lucide-react"
            ...
            <div className="container relative z-20 px-4 md:px-6 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-1">
                        <div
                            className="relative aspect-[2/3] overflow-hidden rounded-lg shadow-lg border border-white/10">
                            <Image src={`https://img.ophim.live/uploads/movies/${thumb_url}` || "/placeholder.svg"}
                                        ...
                                        <TabsContent key={group} value={`group-${group}`} className="mt-0">
                                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                                {server_data
                                                    ...
                                                    .map((ep) => (
                                                        <EpisodeCard key={ep.name} episode={ep} thumb_url={poster}/>
                                                    ))}
                                            </div>
                                        </TabsContent>
                                    ))}
...
function EpisodeCard({episode, thumb_url}: { episode: Episode, thumb_url: string }) {
    return (
        <motion.div
            ...
            <div className="relative aspect-video">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-2">
                    <div className="flex justify-between items-center">
                        ...
                        {/*<span className="text-white/80 text-xs">{episod}</span>*/}
                    </div>
                </div>
            </div>
            <div className="p-2">
